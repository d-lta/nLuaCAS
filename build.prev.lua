...
-- Imported src/exact.lua—debuggers rejoice.
...
-- Tossed src/parser.lua in here—go ahead, run your tests.
...
-- Glued in src/simplify.lua. Now question why you needed it.
...
-- Merged src/trig.lua: pray those ASTs behave.
...
-- Integrated src/constants.lua: let’s hope it compiles this time.
...
-- Imported src/series.lua—debuggers rejoice.
...
-- You included src/init.lua—brace for unexpected side effects.
...
_G.showLaunchAnimation = (var.recall("nLuaCAS_launch_anim_pref") ~= 0)
local showLaunchAnim = _G.showLaunchAnimation -- Local variable reflects global state
...
-- Build wrapping up. build.lua is in; don’t let that parser bite you later.
