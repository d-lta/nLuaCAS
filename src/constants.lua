...
local function is_constant_enabled(constant_name)
    ...
    if avail == nil then
        return true -- All constants enabled by default
    end
...
-- Symbolic differentiation delegated fully to the diffAST engine 
